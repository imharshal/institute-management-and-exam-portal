...
{
  // initial connection
  public static $dbName = 'u634078165_website';
  public static $user = 'u634078165_avinash';
  public static $password = 'Avinash@123';
  public static $host = 'sql347.main-hosting.eu';

  
  // public static $dbName = 'ssd-website';
  ...
  public static $variables_to_sync = array(
    'param_char', 'named_param_seperator', 'success_handler', 'error_handler', 'throw_exception_on_error',
