...
<?php
//check if student information is exist if exist send to enroll course
$isenrolled = DB::queryFirstRow("SELECT id FROM admissions WHERE id = %s", $_SESSION['student']);
if (isset($_GET['x_token']) && isset($isenrolled))
    header("LOCATION: ./enroll_course.php?x_token=%s", $_GET['x_token']);
elseif (isset($isenrolled))
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Admission Form <?php echo $tmp['username'] ?></h1>
                </div>
